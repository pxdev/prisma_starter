                ...
                <div class="relative flex h-full w-full">
                    <div class="relative z-20 flex flex-1 items-center text-white">
                        <div class="flex-1">
                            <u-container>
                                <div class="max-w-4xl">
                                    <p class="mb-2 inline-flex rounded p-1 text-lg items-center gap-2">
                                        <icon class="w-5 h-5" name="hugeicons:location-05" />Al Narjis, North Riyadh,
                                        Riyadh
                                    </p>
                                    <h2
                                        class="mb-6 text-7xl font-semibold leading-tight"
                                        data-swiper-parallax-scale="0.1"
                                    >
                                        Villa 234 SQM Facing West on 12m Width Street
                                    </h2>
                                </div>
                            </u-container>
                        </div>
                    ...
                    <div class="absolute bottom-0 left-0 z-20 flex">
                        <div class="bg-white p-10 details">
                            <div class="flex items-center divide-x space-x-12">
                                ...
                                <div class="flex flex-col gap-2 px-6">
                                    <icon class="h-8 w-8" name="iconoir:ruler-arrows" />
                        ...
                        <div class="flex items-center justify-center px-10 bg-primary-950/50">
                            <base-button>More Details</base-button>
                        </div>
                    </div>
                    <div
