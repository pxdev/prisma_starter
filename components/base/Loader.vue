...
<template>
    <div ref="loader">
        <div class="loader-wrap fixed flex items-center justify-center h-screen w-screen z-50 top-0 left-0">
            <svg
                class="absolute inset-0 h-screen w-screen fill-primary-900"
                preserveAspectRatio="none"
                viewBox="0 0 1000 1000"
            >
                <path id="svg" class="svg-path" d="M0,1005S175,995,500,995s500,5,500,5V0H0Z"></path>
            </svg>
