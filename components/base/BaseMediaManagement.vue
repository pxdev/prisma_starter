    ...
    <section ref="mediaGallery">
        <div class="media-manager">
            <div class="relative rounded-lg border border-dashed bg-gray-50/50 p-4">
                <div
                    class="mb-2 rounded-lg border flex flex-col lg:flex-row gap-2 items-center justify-between border-dashed p-2 media-toolbar"
                >
                    <u-button-group>
                ...
                <div v-if="selectedFiles.length > 0" class="grid grid-cols-2 gap-2 md:grid-cols-4 lg:grid-cols-6">
                    ...
                    >
                        ...
                        <img
                            ...
                            alt=""
                            class="block h-full w-full rounded object-cover object-center transition-all duration-300 group-hover:-rotate-3 group-hover:scale-125"
                        />
                ...
                <div v-else>
                    <div class="text-center rounded-lg my-10 bg-gray-50 dark:bg-gray-900 p-10">
